  ...
  ar: {
    ...
    sections: [
      ...
      },
      {
        ...
        paras: [
          "شاشة كبيرة تعلّقها داخل محلك (تلفزيون أو جهاز لوحي) ليرى العملاء دورهم بأنفسهم. تعرض بأرقام كبيرة كل من يُخدَم الآن — بطاقة لكل موظف، فإن كان أكثر من موظف يعمل ظهرت عدّة أرقام معاً — وتحتها صفّ «القادمون» بأرقام المنتظرين بالترتيب. تتحدّث وحدها كل ٥ ثوانٍ مع نغمة عند نداء رقم جديد. مثالية للمطاعم والعيادات والصالونات المزدحمة.",
          "رابطها الكامل: dawrak.shop/display/رابط-منشأتك — وهو نفس كلمة رابط الحجز ‎/j/…‎ (وليس «رمز المحل QS-XXXX» الخاص بدخول الموظفين). أضمن طريقة: من لوحة المدير اضغط زرّ «📺 شاشة العرض» فيفتح الرابط الصحيح مباشرةً، ثم انسخه.",
        ],
        bullets: [
          "افتح متصفّح التلفزيون أو الجهاز اللوحي واكتب رابط شاشتك.",
          "اجعلها ملء الشاشة: زرّ F11 على الكمبيوتر، أو «ملء الشاشة» من قائمة المتصفّح على الجوال/اللوحي — لإخفاء شريط العنوان.",
          "اضبط الجهاز على «إبقاء الشاشة مضاءة» (إيقاف الإطفاء التلقائي) حتى لا تنطفئ أثناء العمل.",
          "اضغط زرّ «فعّل الصوت» مرة واحدة لتصدر نغمة عند كل نداء جديد (المتصفّحات تتطلب ضغطة أولى لتشغيل الصوت).",
          "اتركها تعمل — لا تحتاج لمسها بعدها؛ تتقدّم تلقائياً كلما ناديت عميلاً أو أكملته من شاشتك.",
        ],
        tip: "الرابط عامّ لا يتطلب تسجيل دخول، فافتحه على أي شاشة مباشرةً. وهي للعرض فقط — لا تُدار منها أي عملية.",
      },
      {
        title: "إحصائياتك",
        paras: [
  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        paras: [
          "A large screen you hang inside your shop (a TV or tablet) so customers can see their turn themselves. It shows, in large numbers, everyone being served right now — one card per employee, so if more than one employee is working several numbers appear together — and below them a 'Coming up' row of the waiting numbers in order. It refreshes itself every 5 seconds with a tone when a new number is called. Ideal for restaurants, clinics, and busy salons.",
          "Its full link: dawrak.shop/display/your-shop-slug — the same word as your booking /j/… link (NOT the 'QS-XXXX' shop code used for staff login). Safest way: from the manager dashboard tap the '📺 Display screen' button — it opens the correct link directly, then copy it.",
        ],
        bullets: [
          "Open the browser on the TV or tablet and type your screen's link.",
          "Make it full screen: F11 on a computer, or 'Full screen' from the browser menu on phone/tablet — to hide the address bar.",
          "Set the device to 'keep screen on' (disable auto-sleep) so it doesn't switch off during work.",
          "Tap the 'Enable sound' button once so it plays a tone on every new call (browsers require a first tap to enable sound).",
          "Leave it running — no further touch needed; it advances automatically whenever you call or complete a customer from your screen.",
        ],
        tip: "The link is public and needs no login, so open it on any screen directly. It's display-only — no operations are run from it.",
      },
      {
  ...
  hi: {
    ...
    sections: [
      ...
      },
      {
        ...
        paras: [
          "एक बड़ी स्क्रीन जो आप अपनी दुकान में लगाते हैं (टीवी या टैबलेट) ताकि ग्राहक खुद अपनी बारी देखें। यह बड़े अंकों में दिखाती है कि अभी किस-किस की सेवा हो रही है — हर कर्मचारी के लिए एक कार्ड, इसलिए एक से ज़्यादा कर्मचारी काम कर रहे हों तो कई नंबर साथ दिखते हैं — और उनके नीचे 'आने वाले' पंक्ति में प्रतीक्षारत नंबर क्रम से। यह हर 5 सेकंड में खुद रिफ़्रेश होती है और नया नंबर बुलाने पर टोन बजाती है। रेस्तराँ, क्लीनिक व व्यस्त सैलून के लिए आदर्श।",
          "इसका पूरा लिंक: dawrak.shop/display/आपका-शॉप-स्लग — वही शब्द जो आपके बुकिंग /j/… लिंक में है (स्टाफ़ लॉगिन वाला 'QS-XXXX' शॉप कोड नहीं)। सबसे सुरक्षित तरीका: मैनेजर डैशबोर्ड से '📺 प्रदर्शन स्क्रीन' बटन दबाएँ — यह सही लिंक सीधे खोलता है, फिर उसे कॉपी करें।",
        ],
        bullets: [
          "टीवी या टैबलेट पर ब्राउज़र खोलें और अपनी स्क्रीन का लिंक टाइप करें।",
          "इसे फ़ुल स्क्रीन करें: कंप्यूटर पर F11, या फ़ोन/टैबलेट पर ब्राउज़र मेनू से 'फ़ुल स्क्रीन' — पता-बार छिपाने के लिए।",
          "डिवाइस को 'स्क्रीन चालू रखें' (ऑटो-स्लीप बंद) पर सेट करें ताकि काम के दौरान बंद न हो।",
          "'ध्वनि चालू करें' बटन एक बार दबाएँ ताकि हर नई कॉल पर टोन बजे (ब्राउज़र ध्वनि के लिए पहली बार टैप माँगते हैं)।",
          "इसे चलने दें — फिर छूने की ज़रूरत नहीं; जब भी आप अपनी स्क्रीन से ग्राहक बुलाते या पूरा करते हैं, यह अपने आप आगे बढ़ती है।",
        ],
        tip: "लिंक सार्वजनिक है और लॉगिन नहीं माँगता, इसलिए इसे किसी भी स्क्रीन पर सीधे खोलें। यह केवल प्रदर्शन के लिए है — इससे कोई संचालन नहीं होता।",
      },
      {
        title: "आपके आँकड़े",
        paras: [
  ...
  bn: {
    ...
    sections: [
      ...
      },
      {
        ...
        paras: [
          "একটি বড় স্ক্রিন যা আপনি আপনার দোকানে লাগান (টিভি বা ট্যাবলেট) যাতে গ্রাহকরা নিজেরাই নিজের পালা দেখতে পারে। এটি বড় সংখ্যায় দেখায় এখন কাকে কাকে সেবা দেওয়া হচ্ছে — প্রতিটি কর্মীর জন্য একটি কার্ড, তাই একাধিক কর্মী কাজ করলে কয়েকটি নম্বর একসাথে দেখায় — এবং তাদের নিচে 'আসন্ন' সারিতে অপেক্ষমাণ নম্বরগুলো ক্রমানুসারে। এটি প্রতি ৫ সেকেন্ডে নিজে রিফ্রেশ হয় এবং নতুন নম্বর ডাকলে টোন বাজায়। রেস্তোরাঁ, ক্লিনিক ও ব্যস্ত সেলুনের জন্য আদর্শ।",
          "এর পূর্ণ লিংক: dawrak.shop/display/আপনার-শপ-স্লাগ — আপনার বুকিং /j/… লিংকের একই শব্দ (কর্মী লগইনের 'QS-XXXX' শপ কোড নয়)। সবচেয়ে নিরাপদ উপায়: ম্যানেজার ড্যাশবোর্ড থেকে '📺 প্রদর্শন স্ক্রিন' বোতাম চাপুন — এটি সঠিক লিংক সরাসরি খোলে, তারপর কপি করুন।",
        ],
        bullets: [
          "টিভি বা ট্যাবলেটে ব্রাউজার খুলুন এবং আপনার স্ক্রিনের লিংক টাইপ করুন।",
          "এটি ফুল স্ক্রিন করুন: কম্পিউটারে F11, বা ফোন/ট্যাবলেটে ব্রাউজার মেনু থেকে 'ফুল স্ক্রিন' — অ্যাড্রেস বার লুকাতে।",
          "ডিভাইসটি 'স্ক্রিন চালু রাখুন' (অটো-স্লিপ বন্ধ) সেট করুন যাতে কাজের সময় বন্ধ না হয়।",
          "'শব্দ চালু করুন' বোতাম একবার চাপুন যাতে প্রতিটি নতুন কলে টোন বাজে (ব্রাউজার শব্দের জন্য প্রথম ট্যাপ চায়)।",
          "এটি চলতে দিন — এরপর আর স্পর্শের দরকার নেই; আপনি আপনার স্ক্রিন থেকে গ্রাহক ডাকলে বা সম্পন্ন করলেই এটি নিজে এগিয়ে যায়।",
        ],
        tip: "লিংকটি সর্বজনীন এবং লগইন চায় না, তাই যেকোনো স্ক্রিনে সরাসরি খুলুন। এটি শুধু প্রদর্শনের জন্য — এটি থেকে কোনো অপারেশন চালানো হয় না।",
      },
      {
