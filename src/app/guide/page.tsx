  ...
  return (
    <main className="theme-general min-h-screen px-5 py-8">
      <div className="w-full max-w-2xl mx-auto flex flex-col gap-6">
        ...
        <Section n={8} title="استقبل وقدّم الخدمة">
          <p className="leading-relaxed">
            من شاشة الموظف: <b>نادِ التالي</b> فيُسحب أقدم عميل ويُنبَّه أن دوره حان، ثم <b>أنهِ
            الخدمة</b> ليتقدّم الطابور تلقائياً. إن لم يحضر العميل <b>تخطّاه</b> (ويمكنك إعادته
            لاحقاً). في الوضع اليدوي تحدّد للعميل التالي <b>وقت جاهزيته</b> بمنزلق بسيط.
          </p>
